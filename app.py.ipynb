...
def budget_tracker():
    ...
    with st.form("transaction_form"):
        ...
        category = cols[1].selectbox("Category", ["Food", "Transport", "Housing", "Entertainment", "Utilities", "Other"])
        amount = cols[2].number_input("Amount ($)", min_value=0.01)
        trans_type = cols[3].radio("Type", ["Income", "Expense"])
